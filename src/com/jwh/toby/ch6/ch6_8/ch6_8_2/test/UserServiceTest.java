package com.jwh.toby.ch6.ch6_8.ch6_8_2.test;

import com.jwh.toby.ch6.ch6_8.ch6_8_2.dao.UserDao;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.domain.Level;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.domain.User;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.pointcut.Bean;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.pointcut.Target;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.service.UserLevelUpgradePolicy;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.service.UserLevelUpgradePolicyGeneral;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.service.UserService;
import com.jwh.toby.ch6.ch6_8.ch6_8_2.service.UserServiceImpl;
...
public class UserServiceTest {
    ...
    public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
        ...
        pointcut.setExpression("execution(public int " +
                "com.jwh.toby.ch6.ch6_8.ch6_8_2.pointcut.Target.minus(int, int) " +
...
//        txDefinition.setReadOnly(true);   //read-only 테스트용
...
//        transactionManager.commit(txStatus);
    ...
    @Test
    public void rollbackTestTemplate() {
        DefaultTransactionDefinition txDefinition = new DefaultTransactionDefinition();
        TransactionStatus txStatus = transactionManager.getTransaction(txDefinition);
